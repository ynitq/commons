...
public class LookupService {
	...
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LookupService.class);
	...
	private final static Map<String, Integer> hashmapcountryCodetoindex = new HashMap<String, Integer>(512);
	private final static Map<String, Integer> hashmapcountryNametoindex = new HashMap<String, Integer>(512);
