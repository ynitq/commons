...
@Service
public class ${table.javaClassName}ApiImpl extends BaseApiImpl implements I${table.javaClassName}Api {


	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(${table.javaClassName}ApiImpl.class);
